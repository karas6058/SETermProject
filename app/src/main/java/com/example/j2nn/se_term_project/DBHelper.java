...
/*
        ...
        db.execSQL("INSERT INTO MOVIE (movieName, grade, director, actor, runningTime, movieImg) VALUES ('당신,거기_있어줄래요','Up_to_12','홍지영','김윤석,변요한,채서진',111,'will_you_be_there','2015년, 우연히 과거로 돌아갈 수 있는 10개의 알약을 얻게 된 수현(김윤석).1985년으로 돌아가 30년 전의 자신(변요한)과 만나게 되고,10번의 기회를 통해 평생 후회하고 있던 과거의 한 사건을 바꾸려 하는데…\n');");
        db.execSQL("INSERT INTO MOVIE (movieName, grade, director, actor, runningTime, movieImg) VALUES ('아기배달부_스토크','All',니콜라스_스톨러','앤디_샘버그,켈시_그래머',87,'storks','아기를 원한다면 주문하세요!올 겨울, 행복을 배달하는 베이비 애니 블록버스터!\n');");
        db.execSQL("INSERT INTO MOVIE (movieName, grade, director, actor, runningTime, movieImg) VALUES ('형','Up_to_12','권수경','조정석,도경수,박신혜',110,'brother','“살다 보니까 니가 내 인생에 도움이 되는 날이 온다?” 뻔뻔한 사기꾼, 동생 핑계로 가석방의 기회를 물었다!\n');");
        db.execSQL("INSERT INTO MOVIE (movieName, grade, director, actor, runningTime, movieImg) VALUES ('신비한_동물사전','Up_to_12','데이빗_예이츠','에디_레드메인,콜린_파렐',133,'fantastic_besats','‘해리 포터’ 마법의 시작!신비한 동물들 탈출, 뉴욕 최대의 위기! 새로운 마법의 시대가 열린다!\n');");
